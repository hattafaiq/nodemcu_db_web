...
const char* ssid = "Turhan Family";                  // Your wifi Name       
const char* password = "innikhikmatin";          // Your wifi Password

const char *host = "192.168.100.24"; //Your pc or server (database) IP, example : 192.168.0.0 , if you are a windows os user, open cmd, then type ipconfig then look at IPv4 Address.
...
void loop() {
  ...
  http.begin("http://192.168.100.24/Nodemcu_db_record_view/InsertDB.php");              //Specify request destination
